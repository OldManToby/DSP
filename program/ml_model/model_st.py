...
class STModel:
    ...
    def load_csv_special_team(self):
        all_data = []
    ...
    def load_data(self):
        # Load data from special_team subfolders
        self.selected_teams_data = self.load_csv_special_team()
        if self.selected_teams_data is not None and not self.selected_teams_data.empty:
            print(f"SpecialTeamModel: Data loaded successfully for {self.away_team} and {self.home_team}")
        else:
            print(f"SpecialTeamModel: No data available for selected teams: {self.away_team} and {self.home_team}")
    ...
    def display_summary(self):
        # Display special_team model summary or any other necessary information
        pass
